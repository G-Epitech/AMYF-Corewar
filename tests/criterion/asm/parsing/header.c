...
Test(parsing_header_of_champion, basic_pdf_file)
{
    ...
    file_t *file = NULL;
    char *input_champion = parse_file("../tests/utils/champions/src/pdf.s");
...
Test(parsing_header_of_champion, basic_bill_file)
{
    champion_t *champion = champion_new();
    file_t *file = NULL;
    char *input_champion = parse_file("../tests/utils/champions/src/bill.s");
...
Test(parsing_header_of_champion, basic_pdd_file)
{
    champion_t *champion = champion_new();
    file_t *file = NULL;
    char *input_champion = parse_file("../tests/utils/champions/src/pdd.s");
...
Test(parsing_header_of_champion, basic_abel_file)
{
    champion_t *champion = champion_new();
    file_t *file = NULL;
    char *input_champion = parse_file("../tests/utils/champions/src/abel.s");
...
Test(parsing_header_of_champion, basic_tyron_file)
{
    champion_t *champion = champion_new();
    file_t *file = NULL;
    char *input_champion = parse_file("../tests/utils/champions/src/tyron.s");
...
Test(parsing_of_champion, bad_malloc_parse_file)
{
    malloc2_mode(MALLOC2_SET_MODE, MALLOC2_MODE_FAIL);
    cr_assert_null(parse_file("test"));
    malloc2_mode(MALLOC2_SET_MODE, MALLOC2_MODE_NORMAL);
}
...
{
    file_t *file = NULL;
    char *input_champion = parse_file("../tests/utils/champions/src/name_too_long.s");
...
{
    file_t *file = NULL;
    char *input_champion = parse_file("../tests/utils/champions/src/comment_too_long.s");
...
{
    file_t *file = NULL;
    char *input_champion = parse_file("../tests/utils/champions/src/bad_word.s");
...
{
    cr_assert_null(parse_file("not exist"));
}
